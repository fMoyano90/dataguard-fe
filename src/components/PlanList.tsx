  ...
  return (
    <section className="demo-panel p-5">
      <div className="mb-4 flex flex-wrap items-center justify-between gap-2">
        <h3 className="text-xl font-black tracking-[-0.05em] text-text-primary">Plan de acción</h3>
        <span className="tag tag-info">Lenguaje simple</span>
      </div>
      <ol className="grid gap-3">
        {plan.map((item, index) => (
          <li className="flex gap-3 rounded-[18px] border border-gray-200 bg-white p-4" key={item}>
